...
{
    /// <summary>
    /// NINetwork - нейронная сеть, представляет из себя структурную еденицу мышления.
    /// </summary>
    public class NINetwork
    {
        ...
        public void initialize()
        {
            ...
            switch (sample_Type) {
                case learnSampleInput.only_this:
        ...
        void backPropagate()
        {
            ...
            for (hid = 0; hid < HIDDEN_NEURONS; hid++)
            {
                ...
                //Обновить смещение
                wih[INPUT_NEURONS.Count, hid] += (LEARN_RATE * errh[hid]);
            }
        }
